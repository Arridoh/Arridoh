...
namakelompok = {
    '1':{'Nurhasna Hi. Saleh': '07352311167'},
    '2':{'M. Arridoh Fuad': '07352311153'},
    '3':{'Muhammad Yasmir Sanaky': '07352311160'},
    '4':{'Nurhasna Majid': '07352311168'},
    '5':{'Riyadh Rafael Hanafi': '07352311173'},
    '6':{'Muhammad Agung': '07352311156'},
    '7':{'Mega Asriyani': '07352311155'},
    '8':{'Putri Jumiana Idris': ''},
    '9':{'Mirnasari Ramatin': ''},
    '10':{'Fauzan Mansur': '07352311180'},
    '11':{'Nurdalifa Marzuki': '07352311166'},
}
...
while True:
    ...
    if pilihan == '1' or pilihan.lower() == 'pesan tiket':
        ...
        while True:
            print('Nama kelompok: ')
            garis()
            for nomor, info in namakelompok.items():
                print(f'Anggota {nomor}: ')
